<template>
  <div class="viewer">
    ...
    <div v-if="showAction" class="demo-action">
      ...
      <a-button type="primary" size="small" ghost @click="loadNormalLine"
        >加载普通线</a-button
      >
      ...
      <a-button type="primary" size="small" ghost @click="loadHeatMap"
        >加载热力图</a-button
      >
      <!-- <a-button type="primary" size="small" ghost @click="loadWaveLine">加载流动线</a-button> -->
      <br /><br />
      ...
      <a-button type="primary" size="small" ghost @click="pointEntity"
        >监控打点</a-button
      >
      <a-button type="primary" size="small" ghost @click="loadPath"
        >路径</a-button
      >
